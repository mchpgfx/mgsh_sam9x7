...
leResult screenShow_Screen0(void)
{
    ...
    Screen0_BaseFillPanel->fn->setSize(Screen0_BaseFillPanel, 480, 640);
    ...
    Screen0_ImageWidget1->fn->setPosition(Screen0_ImageWidget1, 80, 75);
    ...
    Screen0_LabelWidget0->fn->setPosition(Screen0_LabelWidget0, 40, 388);
    ...
    Screen0_LabelWidget1->fn->setPosition(Screen0_LabelWidget1, 155, 388);
    ...
    Screen0_LabelWidget2->fn->setPosition(Screen0_LabelWidget2, 280, 388);
    ...
    Screen0_ButtonWidget0->fn->setPosition(Screen0_ButtonWidget0, 110, 470);
