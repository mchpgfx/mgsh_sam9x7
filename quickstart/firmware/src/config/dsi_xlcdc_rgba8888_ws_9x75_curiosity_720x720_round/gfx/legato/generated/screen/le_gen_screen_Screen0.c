...
leResult screenShow_Screen0(void)
{
    ...
    Screen0_BaseFillPanel->fn->setSize(Screen0_BaseFillPanel, 720, 720);
    ...
    Screen0_ImageWidget0->fn->setPosition(Screen0_ImageWidget0, 284, 50);
    ...
    Screen0_ImageWidget1->fn->setPosition(Screen0_ImageWidget1, 200, 120);
    ...
    Screen0_LabelWidget0->fn->setPosition(Screen0_LabelWidget0, 160, 450);
    ...
    Screen0_LabelWidget1->fn->setPosition(Screen0_LabelWidget1, 275, 450);
    ...
    Screen0_LabelWidget2->fn->setPosition(Screen0_LabelWidget2, 400, 450);
    ...
    Screen0_ButtonWidget0->fn->setPosition(Screen0_ButtonWidget0, 230, 550);
    ...
    root3->fn->addChild(root3, (leWidget*)Screen0_ButtonWidget0);
