...
leResult screenShow_Screen0(void)
{
    ...
    Screen0_BaseFillPanel->fn->setSize(Screen0_BaseFillPanel, 480, 800);
    ...
    Screen0_ImageWidget1->fn->setPosition(Screen0_ImageWidget1, 80, 115);
    ...
    Screen0_LabelWidget0->fn->setPosition(Screen0_LabelWidget0, 40, 488);
    ...
    Screen0_LabelWidget1->fn->setPosition(Screen0_LabelWidget1, 155, 488);
    ...
    Screen0_LabelWidget2->fn->setPosition(Screen0_LabelWidget2, 280, 488);
    ...
    Screen0_ButtonWidget0->fn->setPosition(Screen0_ButtonWidget0, 110, 620);
