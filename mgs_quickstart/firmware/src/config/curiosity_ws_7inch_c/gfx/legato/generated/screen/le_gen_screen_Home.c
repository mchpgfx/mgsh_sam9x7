...
leResult screenShow_Home(void)
{
    ...
    Home_BackgroundPanel->fn->setSize(Home_BackgroundPanel, 1024, 600);
    ...
    Home_ImageWidgetMCHPLogo->fn->setPosition(Home_ImageWidgetMCHPLogo, 798, 16);
    ...
    Home_ImageWidgetMGSLogo->fn->setPosition(Home_ImageWidgetMGSLogo, 16, 517);
    ...
    Home_ButtonWidgetQuickStart->fn->setPosition(Home_ButtonWidgetQuickStart, 764, 517);
    ...
    Home_LabelWidget_0->fn->setPosition(Home_LabelWidget_0, 183, 230);
    ...
    Home_LabelWidget_1->fn->setPosition(Home_LabelWidget_1, 379, 230);
    ...
    Home_LabelWidget_2->fn->setPosition(Home_LabelWidget_2, 586, 230);
