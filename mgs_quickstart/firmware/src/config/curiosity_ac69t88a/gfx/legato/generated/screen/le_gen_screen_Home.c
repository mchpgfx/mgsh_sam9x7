...
leResult screenShow_Home(void)
{
    ...
    Home_ImageWidgetMGSLogo->fn->setPosition(Home_ImageWidgetMGSLogo, 16, 397);
    ...
    Home_ButtonWidgetQuickStart->fn->setPosition(Home_ButtonWidgetQuickStart, 544, 397);
    ...
    Home_LabelWidget_0->fn->setPosition(Home_LabelWidget_0, 73, 160);
    ...
    Home_LabelWidget_1->fn->setPosition(Home_LabelWidget_1, 269, 160);
    ...
    Home_LabelWidget_2->fn->setPosition(Home_LabelWidget_2, 476, 160);
