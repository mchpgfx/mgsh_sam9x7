...
leResult screenShow_Home(void)
{
    ...
    // layer 0
    root0 = leWidget_New();
    root0->fn->setSize(root0, 480, 640);
    ...
    Home_BackgroundPanel->fn->setSize(Home_BackgroundPanel, 480, 640);
    ...
    Home_ImageWidgetMCHPLogo->fn->setPosition(Home_ImageWidgetMCHPLogo, 137, 16);
    ...
    Home_ImageWidgetMGSLogo->fn->setPosition(Home_ImageWidgetMGSLogo, 120, 557);
    ...
    Home_ButtonWidgetQuickStart->fn->setPosition(Home_ButtonWidgetQuickStart, 120, 464);
    ...
    // layer 1
    root1 = leWidget_New();
    root1->fn->setSize(root1, 480, 640);
    ...
    Home_LabelWidget_0->fn->setPosition(Home_LabelWidget_0, 181, 123);
    ...
    Home_LabelWidget_1->fn->setPosition(Home_LabelWidget_1, 167, 213);
    ...
    Home_LabelWidget_2->fn->setPosition(Home_LabelWidget_2, 112, 303);
